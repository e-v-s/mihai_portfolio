	...
	return(
		<div className={css(style.page)}>
			<p className={css(style.text)}>
				Graduated as an Electrical Engineer at the Technical Univeristy of Köln (Cologne) in Germany in 2005. Have been involved with the Automation and SCADA Industry before University graduation, I have been working more than 10 years as Project Engineer, System Integrator, SCADA/PLC and ADMS specialist. The last 10 years were in the Oil&Gas and Utilities Industries.
			</p>
			<p className={css(style.text)}>
