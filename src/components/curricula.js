...
function Curricula(props) {
	let template = 
		<section className={css(styleExperience.section)}>
			<div className={css(styleExperience.divYellow)}>
...
const styleExperience = StyleSheet.create({
	section: {
		padding: '80px 0',
	},
	divYellow: {
